...
public class Main {
	public static void main(String[] args) {
		...
		abilityList[0] = "1: Healing Flash";
		abilityList[1] = "2: Defensive Shield";
		abilityList[2] = "3: Magic Blast";
		abilityList[3] = "4: Magic Storm";
				...
				try {
					...
					if (playerChoice == 1) {
						...
						if (player1.getAttackStat() + 5 > enemy1.getDefenseStat()) {
							if (-1 * ((player1.getAttackStat() + 5) - enemy1.getDefenseStat()) < 0) {
							enemy1.setHealth(-1 * ((player1.getAttackStat() + 5) - enemy1.getDefenseStat()));
							}
						}
					}
							...
							if (abilityChoice == 1) {
								...
								if (abilityCostList[2] <= player1.getEnergy()) {
									...
									if (player1.getAttackStat() + 10 > enemy1.getDefenseStat()) {
										if (-1 * ((player1.getAttackStat() + 10) - enemy1.getDefenseStat()) < 0) {
										enemy1.setHealth(-1 * ((player1.getAttackStat() + 10) - enemy1.getDefenseStat()));
										}
									}
									player1.setEnergy(-5);
								}
								...
								if (abilityCostList[3] <= player1.getEnergy()) {
									...
									if (player1.getAttackStat() + 20 > enemy1.getDefenseStat()) {
										if (-1 * ((player1.getAttackStat() + 20) - enemy1.getDefenseStat()) < 0) {
										enemy1.setHealth(-1 * ((player1.getAttackStat() + 20) - enemy1.getDefenseStat()));
										}
									}
			...
			if (enemy1.getHealth() / enemy1.getMaxHealth() >= .80 && enemyStage1 == true) {
				...
				if (enemyChoice <= 9) {
					...
					if (enemy1.getAttackStat() + enemy1.getMoveA1() > player1.getDefenseStat()) {
						if (-1 * ((enemy1.getAttackStat() + enemy1.getMoveA1()) - player1.getDefenseStat()) < 0) {
						player1.setHealth(-1 * ((enemy1.getAttackStat() + enemy1.getMoveA1()) - player1.getDefenseStat()));
						}
					}
				}
				else {
					...
					if ((enemy1.getAttackStat() + enemy1.getMoveA2()) > player1.getDefenseStat()) {
						if (-1 * ((enemy1.getAttackStat() + enemy1.getMoveA2()) - player1.getDefenseStat()) < 0) {
						player1.setHealth(-1 * ((enemy1.getAttackStat() + enemy1.getMoveA2()) - player1.getDefenseStat()));
						}
					}
				}
			}
//60% health phase	
				...
				if (enemyChoice <= 9) {
					...
					if (enemy1.getAttackStat() + enemy1.getMoveB1() > player1.getDefenseStat()) {
						if (-1 * ((enemy1.getAttackStat() + enemy1.getMoveB1()) - player1.getDefenseStat()) < 0) {
						player1.setHealth(-1 * ((enemy1.getAttackStat() + enemy1.getMoveB1()) - player1.getDefenseStat()));
						}
					}
				}
				else {
					...
					if (enemy1.getAttackStat() + enemy1.getMoveB2() > player1.getDefenseStat()) {
						if (-1 * ((enemy1.getAttackStat() + enemy1.getMoveB2()) - player1.getDefenseStat()) < 0) {
						player1.setHealth(-1 * ((enemy1.getAttackStat() + enemy1.getMoveB2()) - player1.getDefenseStat()));
						}
					}
				}
			}
//40% health phase	
				...
				if (enemyChoice <= 9) {
					...
					if (enemy1.getAttackStat() + enemy1.getMoveC1() > player1.getDefenseStat()) {
						if (-1 * ((enemy1.getAttackStat() + enemy1.getMoveC1()) - player1.getDefenseStat()) < 0) {
						player1.setHealth(-1 * ((enemy1.getAttackStat() + enemy1.getMoveC1()) - player1.getDefenseStat()));
						}
					}
				}
				else {
					...
					if (enemy1.getAttackStat() + enemy1.getMoveC2() > player1.getDefenseStat()) {
						if (-1 * ((enemy1.getAttackStat() + enemy1.getMoveC2()) - player1.getDefenseStat()) < 0) {
						player1.setHealth(-1 * ((enemy1.getAttackStat() + enemy1.getMoveC2()) - player1.getDefenseStat()));
						}
					}
				}
			}
//20% health phase	
				...
				if (enemyChoice <= 9) {
					...
					if (enemy1.getAttackStat() + enemy1.getMoveD1() > player1.getDefenseStat()) {
						if (-1 * ((enemy1.getAttackStat() + enemy1.getMoveD1()) - player1.getDefenseStat()) < 0) {
						player1.setHealth(-1 * ((enemy1.getAttackStat() + enemy1.getMoveD1()) - player1.getDefenseStat()));
						}
					}
				}
				else {
					...
					if (enemy1.getAttackStat() + enemy1.getMoveD2() > player1.getDefenseStat()) {
						if (-1 * ((enemy1.getAttackStat() + enemy1.getMoveD2()) - player1.getDefenseStat()) < 0) {
						player1.setHealth(-1 * ((enemy1.getAttackStat() + enemy1.getMoveD2()) - player1.getDefenseStat()));
						}
					}
				}
			}
//01% health phase	
				...
				if (enemyChoice <= 9) {
					...
					if (enemy1.getAttackStat() + enemy1.getMoveE1() > player1.getDefenseStat()) {
						if (-1 * ((enemy1.getAttackStat() + enemy1.getMoveE1()) - player1.getDefenseStat()) < 0) {
						player1.setHealth(-1 * ((enemy1.getAttackStat() + enemy1.getMoveE1()) - player1.getDefenseStat()));
						}
					}
				}
				else {
					...
					if (enemy1.getAttackStat() + enemy1.getMoveE2() > player1.getDefenseStat()) {
						if (-1 * ((enemy1.getAttackStat() + enemy1.getMoveE2()) - player1.getDefenseStat()) < 0) {
						player1.setHealth(-1 * ((enemy1.getAttackStat() + enemy1.getMoveE2()) - player1.getDefenseStat()));
						}
					}
				}
			}
